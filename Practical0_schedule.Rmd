...
My preference (and recommendation to you) is to put all your CSV files into a `Data` subfolder in your `NES2303` folder, in which case you'll need to remember to add `Data/` to any `read.csv` commands.
That way your NES2303 folder is less likely to get cluttered as you go through the module.
...
Edit the following two lines to put the correct text inside the `()` brackets:
